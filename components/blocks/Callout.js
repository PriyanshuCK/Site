  ...
  return (
    <div className="my-2 rounded-2xl border border-primary-500 p-6 shadow-md shadow-primary-100 ring-1 ring-black/5 prose-p:m-0 dark:bg-gray-800 dark:shadow-gray-800 dark:ring-white/10 sm:mx-auto sm:w-4/5">
      <div className="float-left mr-4 mb-1">
        <div className="h-[80px] w-[80px] overflow-hidden rounded-full p-[5px] shadow-md shadow-primary-100 [background:linear-gradient(-45deg,rgba(0,0,0,.1),rgba(255,255,255,.3))] dark:shadow-gray-700">
